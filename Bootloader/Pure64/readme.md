...
Building Pure64 from source requires NASM v2.10 or higher; the version included in the OS X 10.9 Developer Tools is not recent enough. - _Seriously Apple? NASM v0.98 is from 2007!!_
